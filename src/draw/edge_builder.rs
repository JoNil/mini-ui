use crate::draw::edge::{CubicEdge, Edge, LineEdge, QuadraticEdge};
use crate::draw::edge_clipper::EdgeClipperIter;
use crate::draw::geom::ScreenIntRect;
use crate::draw::path_geometry;
use crate::draw::{Path, Point};
...
impl BasicEdgeBuilder {
    ...
    pub fn build_edges(
        ...
        if !builder.build(path, clip, can_cull_to_the_right) {
            eprintln!("infinite or NaN segments detected during edges building");
            return None;
        }
