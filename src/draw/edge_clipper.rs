use crate::{
    draw::{
        edge_builder::{edge_iter, PathEdge, PathEdgeIter},
        line_clipper, path_geometry, Path, Point, Rect,
    },
    path::{NormalizedF32Exclusive, SCALAR_MAX},
};
...
pub type ClippedEdges = Vec<PathEdge>;
