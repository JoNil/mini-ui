use crate::path::path_geometry::valid_unit_divide;
pub use crate::path::path_geometry::{
    chop_cubic_at2, chop_quad_at, find_cubic_max_curvature, find_unit_quad_roots, new_t_values,
    CubicCoeff, QuadCoeff,
};
use crate::path::{NormalizedF32, NormalizedF32Exclusive, Point};
...
fn cubic_dchop_at_intercept(
    ...
    use crate::draw::path64::{cubic64::Cubic64, line_cubic_intersections, point64::Point64};
