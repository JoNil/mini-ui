use crate::path::{
    ...
    path::{PathSegment, PathSegmentsIter},
    path_builder::{PathBuilder, PathDirection},
    path_geometry,
    scalar::{Scalar, SCALAR_NEARLY_ZERO, SCALAR_ROOT_2_OVER_2},
    NormalizedF32, Path, Point, Transform,
};

#[cfg(all(not(feature = "std"), feature = "no-std-float"))]
use crate::NoStdFloat;

use super::NonZeroPositiveF32;
