...
impl Context {
    ...
    #[inline]
    pub unsafe fn from_raw_borrow(ptr: *mut ffi::cairo_t) -> crate::cairo::Borrowed<Context> {
        debug_assert!(!ptr.is_null());
        crate::cairo::Borrowed::new(Context(ptr::NonNull::new_unchecked(ptr)))
    }
...
mod tests {
    ...
    use super::*;
    use crate::cairo::{enums::Format, image_surface::ImageSurface, patterns::LinearGradient};
