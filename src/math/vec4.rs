...
impl Vec4 {
    ...
    pub fn copysign(self, rhs: Self) -> Self {
        Self {
            x: f32::copysign(self.x, rhs.x),
            y: f32::copysign(self.y, rhs.y),
            z: f32::copysign(self.z, rhs.z),
            w: f32::copysign(self.w, rhs.w),
        }
    }
    ...
    pub fn div_euclid(self, rhs: Self) -> Self {
        Self::new(
            f32::div_euclid(self.x, rhs.x),
            f32::div_euclid(self.y, rhs.y),
            f32::div_euclid(self.z, rhs.z),
            f32::div_euclid(self.w, rhs.w),
        )
    }
    ...
    pub fn rem_euclid(self, rhs: Self) -> Self {
        Self::new(
            f32::rem_euclid(self.x, rhs.x),
            f32::rem_euclid(self.y, rhs.y),
            f32::rem_euclid(self.z, rhs.z),
            f32::rem_euclid(self.w, rhs.w),
        )
    }
    ...
    /// Panics
    ///
    /// Will panic if the resulting normalized vector is not finite when `assert` is enabled.
    #[inline]
    #[must_use]
    ...
    pub fn is_normalized(self) -> bool {
        f32::abs(self.length_squared() - 1.0) <= 2e-4
    }
    ...
    /// # Panics
    ///
    /// Will panic if `min` is greater than `max`, or if either `min` or `max` is negative, when `assert` is enabled.
    #[inline]
    #[must_use]
    ...
    /// # Panics
    ///
    /// Will panic if `max` is negative when `assert` is enabled.
    #[inline]
    #[must_use]
    ...
    /// # Panics
    ///
    /// Will panic if `min` is negative when `assert` is enabled.
    #[inline]
    #[must_use]
    ...
    pub fn mul_add(self, a: Self, b: Self) -> Self {
        Self::new(
            f32::mul_add(self.x, a.x, b.x),
            f32::mul_add(self.y, a.y, b.y),
            f32::mul_add(self.z, a.z, b.z),
            f32::mul_add(self.w, a.w, b.w),
        )
    }
}
