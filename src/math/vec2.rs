...
impl Vec2 {
    ...
    pub fn exp(self) -> Self {
        Self::new(f32::exp(self.x), f32::exp(self.y))
    }
    ...
    pub fn powf(self, n: f32) -> Self {
        Self::new(f32::powf(self.x, n), f32::powf(self.y, n))
    }
    ...
    pub fn angle_to(self, rhs: Self) -> f32 {
        let angle =
            f32::acos(self.dot(rhs) / f32::sqrt(self.length_squared() * rhs.length_squared()));

        angle * f32::signum(self.perp_dot(rhs))
    }
    ...
    pub fn rotate_towards(&self, rhs: Self, max_angle: f32) -> Self {
        ...
        let angle = max_angle.clamp(abs_a - core::f32::consts::PI, abs_a) * f32::signum(a);
